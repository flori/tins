...
Gem::Specification.new do |s|
  ...
  s.test_files = ["tests/tins_file_binary_test.rb", "tests/tins_lines_file_test.rb", "tests/tins_memoize_test.rb", "tests/tins_secure_write_test.rb", "tests/tins_test.rb"]
